...
import type { DocumentationFragment, FragmentStore } from "./FragmentStore.js";
import type { ScriptStore, ScriptStoreEntry } from "./ScriptStore.js";
...
export class Validator {
	...
	generateReport(withLocals = false): ValidationReport {
		...
		for (const scriptMeta of this.metadataFromScan.scripts) {
			...
			const fragment = mustExist(
				this.fragmentStore.fragments.get(scriptMeta.scriptName),
			);
